...
namespace RB10.Bot.Line
{
    public static class ParrotFunction
    {
        [FunctionName("ParrotFunction")]
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post", Route = null)]HttpRequestMessage req, TraceWriter log)
        {
            ...
            var ChannelAccessToken = "BAJ+49KGp7Wx2CmlusFUbZDWOzGYZN+klPBwKzNu2CFFePrhK1m8oFN8V9cycqZJFkm/D0xsYtMOlYoY1RFrzXMmlV2MZzvRVngBRGhw3lb87J0wfZfAZQRHCKlPktzbU+D/qbLcsfVDlikGTNk8+gdB04t89/1O/w1cDnyilFU=";
